...
:root{
  ...
  color-scheme: light;                     /* cegah tema gelap browser */
}
...
/* Warna tombol dikunci agar tidak mengikuti tema gelap */
.stButton > button[kind="primary"]{
  background:var(--accent) !important; border:1px solid var(--accent) !important; color:#FFFDF8 !important;
}
.stButton > button[kind="primary"]:disabled{
  background:var(--accent-soft) !important; border-color:var(--line) !important; color:var(--muted) !important;
}
...
/* Toast/notifikasi tetap terbaca */
[data-testid="stToast"]{
  background:var(--card) !important; color:var(--ink) !important; border:1px solid var(--line) !important;
}
